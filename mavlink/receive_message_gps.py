...
# connect to vehicle
vehicle = utility.mavlink_connection(device="/dev/ttyACM0,115200")
...
while True:
    ...
    try:
        ...
        # receive a message
        message = vehicle.recv_match(type=dialect.MAVLink_gps_raw_int_message.msgname, blocking=True)

        # convert received message to dictionary
        message = message.to_dict()

        # for each field name in field names of this message
        for field_name in dialect.MAVLink_gps_raw_int_message.fieldnames:
